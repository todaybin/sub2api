            ...
            <div class="space-y-5 p-6">
              ...
              <template v-else>
                ...
                <div class="flex items-center justify-between gap-4 border-t border-gray-100 pt-4 dark:border-dark-700">
                  <div>
                    <label class="font-medium text-gray-900 dark:text-white">
                      {{ t("admin.settings.upstreamBillingProbe.autoDisableZeroBalance") }}
                    </label>
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.upstreamBillingProbe.autoDisableZeroBalanceHint") }}
                    </p>
                  </div>
                  <Toggle
                    v-model="upstreamBillingProbeForm.auto_disable_zero_balance"
                    :disabled="!upstreamBillingProbeForm.enabled"
                    :aria-label="t('admin.settings.upstreamBillingProbe.autoDisableZeroBalance')"
                    data-testid="upstream-billing-auto-disable-zero-balance"
                  />
                </div>
