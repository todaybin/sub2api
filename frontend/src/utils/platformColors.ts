...
const BADGE: Record<Platform, string> = {
  ...
  codebuddy: 'bg-cyan-500/10 text-cyan-700 border-cyan-500/30 dark:text-cyan-300',
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  codebuddy: 'bg-cyan-500/10 text-cyan-700 dark:bg-cyan-500/10 dark:text-cyan-300',
...
const TEXT: Record<Platform, string> = {
  ...
  codebuddy: 'text-cyan-700 dark:text-cyan-300',
...
const ICON: Record<Platform, string> = {
  ...
  codebuddy: 'text-cyan-600 dark:text-cyan-300',
...
const BUTTON: Record<Platform, string> = {
  ...
  codebuddy: 'bg-cyan-600 text-white hover:bg-cyan-700 active:bg-cyan-800 dark:bg-cyan-600/80 dark:hover:bg-cyan-500',
...
const DISCOUNT: Record<Platform, string> = {
  ...
  codebuddy: 'bg-cyan-100 text-cyan-800 dark:bg-cyan-900/40 dark:text-cyan-300',
