export default {
    ...
    groups: {
      ...
      rateLabel: 'rate',
      dynamicRate: 'Dynamic',
      dynamicRateSource: 'Upstream max {value}x',
      dynamicRateNoSource: 'Waiting for upstream rate',
      dynamicRateIncrease: 'Last increase',
      dynamicRateDecrease: 'Last decrease',
      dynamicRateStatus: {
        idle: 'Disabled',
        waiting: 'Waiting for a valid balance snapshot',
        ready: 'Data complete',
        incomplete: 'Incomplete data; decreases paused',
        paused: 'Global probing disabled'
      },
      accountFilters: {
      ...
      form: {
        ...
        dynamicRateMarkup: 'Markup percentage',
        dynamicRateMarkupHint: 'Calculated from the highest upstream multiplier among valid balance-billed accounts. Incomplete data allows increases but freezes decreases.',
        status: 'Status',
