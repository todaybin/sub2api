export default {
    settings: {
      ...
      upstreamBillingProbe: {
        ...
        autoDisableZeroBalance: 'Auto-disable on zero balance',
        autoDisableZeroBalanceHint: 'Disabled by default. When enabled, balance-based upstream accounts with a balance at or below zero stop scheduling only when global and account-level probing are also enabled. Account status is unchanged and recovery is manual.',
