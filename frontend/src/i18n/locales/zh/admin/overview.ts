export default {
    ...
    groups: {
      ...
      form: {
        ...
        fixedRate: '固定倍率',
        dynamicRate: '动态倍率',
        dynamicRateMarkup: '加价百分比',
        dynamicRateMarkupHint: '按当前有效余额计费账号的最高上游倍率计算；数据不完整时只允许涨价，不执行降价。',
        status: '状态',
        exclusive: '专属分组',
        nameLabel: '分组名称',
      ...
      rateLabel: '倍率',
      dynamicRate: '动态',
      dynamicRateSource: '上游最高 {value}x',
      dynamicRateNoSource: '等待上游倍率',
      dynamicRateIncrease: '上次涨价',
      dynamicRateDecrease: '上次降价',
      dynamicRateStatus: {
        idle: '未启用',
        waiting: '等待有效余额快照',
        ready: '数据完整',
        incomplete: '数据不完整，暂停降价',
        paused: '全局探测已停用'
      },
      accountFilters: {
        title: '账号过滤控制',
      ...
      modelAllowlist: {
        title: '模型白名单（{endpoint}）',
        hint: '开启后，不在白名单中的模型会被拒绝（404 model_not_found），{endpoint} 也只展示白名单内的模型。条目支持精确模型 ID 与末尾 * 通配。注意：Claude Code 会用 haiku 系小模型做标题/摘要等探测，/messages/count_tokens 同样受白名单控制，请一并勾选所需的小模型。',
        loading: '正在加载候选模型...',
