...
```dotenv
APPLE_CONTAINER_SUB2API_IMAGE=ghcr.io/todaybin/sub2api:0.1.175-custom.1
...
SUB2API_IMAGE=ghcr.io/todaybin/sub2api:0.1.175-custom.1 # Match APPLE_CONTAINER_SUB2API_IMAGE in .env.
