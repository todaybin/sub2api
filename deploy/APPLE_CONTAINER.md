...
```dotenv
APPLE_CONTAINER_SUB2API_IMAGE=ghcr.io/todaybin/sub2api:0.1.173-custom.3
...
SUB2API_IMAGE=ghcr.io/todaybin/sub2api:0.1.173-custom.3 # Match APPLE_CONTAINER_SUB2API_IMAGE in .env.
