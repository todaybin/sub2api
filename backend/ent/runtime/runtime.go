...
func init() {
	...
	// groupDescRateMode is the schema descriptor for rate_mode field.
	groupDescRateMode := groupFields[3].Descriptor()
	// group.DefaultRateMode holds the default value on creation for the rate_mode field.
	group.DefaultRateMode = groupDescRateMode.Default.(string)
	// group.RateModeValidator is a validator for the "rate_mode" field. It is called by the builders before save.
	group.RateModeValidator = groupDescRateMode.Validators[0].(func(string) error)
	// groupDescDynamicRateMarkupPercent is the schema descriptor for dynamic_rate_markup_percent field.
	groupDescDynamicRateMarkupPercent := groupFields[4].Descriptor()
	// group.DefaultDynamicRateMarkupPercent holds the default value on creation for the dynamic_rate_markup_percent field.
	group.DefaultDynamicRateMarkupPercent = groupDescDynamicRateMarkupPercent.Default.(float64)
	// groupDescDynamicRateStatus is the schema descriptor for dynamic_rate_status field.
	groupDescDynamicRateStatus := groupFields[6].Descriptor()
	// group.DefaultDynamicRateStatus holds the default value on creation for the dynamic_rate_status field.
	group.DefaultDynamicRateStatus = groupDescDynamicRateStatus.Default.(string)
	// group.DynamicRateStatusValidator is a validator for the "dynamic_rate_status" field. It is called by the builders before save.
	group.DynamicRateStatusValidator = groupDescDynamicRateStatus.Validators[0].(func(string) error)
	// groupDescDynamicRateLastDirection is the schema descriptor for dynamic_rate_last_direction field.
	groupDescDynamicRateLastDirection := groupFields[7].Descriptor()
	// group.DefaultDynamicRateLastDirection holds the default value on creation for the dynamic_rate_last_direction field.
	group.DefaultDynamicRateLastDirection = groupDescDynamicRateLastDirection.Default.(string)
	// group.DynamicRateLastDirectionValidator is a validator for the "dynamic_rate_last_direction" field. It is called by the builders before save.
	group.DynamicRateLastDirectionValidator = groupDescDynamicRateLastDirection.Validators[0].(func(string) error)
	// groupDescPeakRateEnabled is the schema descriptor for peak_rate_enabled field.
	groupDescPeakRateEnabled := groupFields[11].Descriptor()
	...
	groupDescPeakStart := groupFields[12].Descriptor()
	...
	groupDescPeakEnd := groupFields[13].Descriptor()
	...
	groupDescPeakRateMultiplier := groupFields[14].Descriptor()
	...
	groupDescIsExclusive := groupFields[15].Descriptor()
	...
	groupDescStatus := groupFields[16].Descriptor()
	...
	groupDescDuplicateOperationID := groupFields[17].Descriptor()
	...
	groupDescPlatform := groupFields[18].Descriptor()
	...
	groupDescSubscriptionType := groupFields[19].Descriptor()
	...
	groupDescDefaultValidityDays := groupFields[23].Descriptor()
	...
	groupDescAllowImageGeneration := groupFields[24].Descriptor()
	...
	groupDescSearchPricePer1k := groupFields[40].Descriptor()
	...
	groupDescAudioRealtimePricePerMin := groupFields[41].Descriptor()
	...
	groupDescAudioTtsPricePerMillionChars := groupFields[42].Descriptor()
	...
	groupDescAudioSttPricePerHour := groupFields[43].Descriptor()
	...
	groupDescLongContextPricingEnabled := groupFields[44].Descriptor()
	...
	groupDescClaudeCodeOnly := groupFields[46].Descriptor()
	...
	groupDescForceOpenaiFast := groupFields[56].Descriptor()
	...
	groupDescFreeOpenaiFast := groupFields[57].Descriptor()
	...
	groupDescModelAllowlist := groupFields[62].Descriptor()
	...
	groupDescCodexModelsManifestConfig := groupFields[63].Descriptor()
	...
	groupDescMaxReasoningEffortOverLimit := groupFields[66].Descriptor()
