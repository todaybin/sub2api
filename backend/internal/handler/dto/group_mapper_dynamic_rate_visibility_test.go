...
func TestGroupDynamicRateVisibility(t *testing.T) {
	...
	for _, field := range []string{"rate_mode", "dynamic_rate_last_direction", "dynamic_rate_last_adjusted_at"} {
	...
	for _, field := range []string{"rate_mode", "dynamic_rate_last_direction", "dynamic_rate_last_adjusted_at", "dynamic_rate_markup_percent", "dynamic_rate_source_multiplier", "dynamic_rate_status", "dynamic_rate_last_evaluated_at"} {
