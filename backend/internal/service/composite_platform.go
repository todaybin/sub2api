...
func DetectModelPlatform(model string) (string, bool) {
	...
	case normalized == "k3",
		...
		return PlatformKimi, true
	case strings.HasPrefix(normalized, "glm-5v"),
		strings.HasPrefix(normalized, "hunyuan-"),
		strings.HasPrefix(normalized, "codebuddy-"):
		return PlatformCodeBuddy, true
...
func isConcreteRequestPlatform(platform string) bool {
	...
	case PlatformAnthropic, PlatformOpenAI, PlatformGemini, PlatformAntigravity, PlatformGrok,
		PlatformKimi, PlatformZhipu, PlatformDeepseek, PlatformMiniMax, PlatformCodeBuddy:
		return true
	default:
		return false
	}
