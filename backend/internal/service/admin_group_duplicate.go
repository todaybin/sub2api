...
func cloneGroupForDuplicate(source *Group, operationID string) *Group {
	return &Group{
		...
		RateMode:                        source.RateMode,
		DynamicRateMarkupPercent:        source.DynamicRateMarkupPercent,
		DynamicRateStatus:               map[bool]string{true: DynamicRateStatusWaiting, false: DynamicRateStatusIdle}[source.RateMode == GroupRateModeDynamic],
