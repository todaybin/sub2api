...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	dynamicGroupRateService := service.NewDynamicGroupRateService(groupRepository, accountRepository, settingService, apiKeyAuthCacheInvalidator)
	adminService := service.NewAdminService(userRepository, adminGroupRepository, adminAccountRepository, proxyRepository, apiKeyRepository, redeemCodeRepository, userGroupRateRepository, userRPMCache, billingCacheService, proxyExitInfoProber, proxyLatencyCache, apiKeyAuthCacheInvalidator, client, settingService, subscriptionService, userSubscriptionRepository, privacyClientFactory, openAIGatewayService, affiliateService, compositeModelRouteRepository, compositeRouteResolver, dynamicGroupRateService, channelService)
	...
	provisioningHandler := admin.NewProvisioningHandler(adminService, apiKeyService, subscriptionService)
	...
	engine := server.ProvideRouter(configConfig, handlers, jwtAuthMiddleware, optionalJWTAuthMiddleware, adminAuthMiddleware, apiKeyAuthMiddleware, auditLogMiddleware, stepUpAuthMiddleware, apiKeyService, subscriptionService, userService, opsService, settingService, compositeRouteResolver, redisClient)
	...
	codeBuddyCheckinRunnerService := service.ProvideCodeBuddyCheckinRunnerService(adminService, configConfig, leaderLockCache)
	scheduledTestRunnerService := service.ProvideScheduledTestRunnerService(scheduledTestPlanRepository, scheduledTestService, accountTestService, rateLimitService, codeBuddyCheckinRunnerService, configConfig)
	accountHandler.SetCodeBuddyCheckinRunner(codeBuddyCheckinRunnerService)
